...
<div>
  ...
  >
    <a-form
      ...
      ref="editRef"
    >
      <a-form-item label="具体介绍" :labelCol="{span: 4}" :wrapperCol="{span: 20}" class="editForm" name="introduce">
...
export default {
  setup() {
    ...
    //#region 使用介绍列表编辑方法
    const { editVisible,editRef,editModel,editRule,showEditModal,editSubmit } = useEditIntroList(getIntroList);
    //#endregion
