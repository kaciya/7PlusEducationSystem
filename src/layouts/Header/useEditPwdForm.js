...
export function useEditPwdForm() {
    ...
    const editPwdForm = reactive({
        ...
        rules: {
            ...
            newPwd: [{ required: true, message: "请输入新密码", trigger: "blur" }, { validator: validatePwd, trigger: 'blur' }],
            checkPwd: [{ required: true, message: "请输入确认密码", trigger: "blur" }, { validator: validatePwd2, trigger: 'blur' }]
        },
    });
    //#endregion
