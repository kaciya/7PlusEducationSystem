    ...
    <a-card style="min-height: 93%; min-width: 1208px">
      ...
      >
        ...
        <template #extra>
          ...
          <!-- 添加题目按钮 -->
          <a-button type="primary" @click="showAddModal" v-has="'question:listen:edit'">添加</a-button>
          <!-- 添加题目模态框 start -->
      ...
      >
        ...
        <template #operation="{ record }">
          <a-button type="primary" size="small" @click="showGetModal(record.id)" v-has="'question:listen:detail'"
            >查看</a-button
          >
          <!-- 上传音频按钮-->
          ...
          >
            <a-button type="danger" style="margin-left: 10px" size="small" v-has="'question:delete'"
              >删除</a-button
            >
          </a-popconfirm>
        </template>
